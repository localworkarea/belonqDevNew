(() => {
    ...
    function ssr_window_esm_extend(target, src) {
        ...
        Object.keys(src).forEach((key => {
            if (typeof target[key] === "undefined") target[key] = src[key]; else if (ssr_window_esm_isObject(src[key]) && ssr_window_esm_isObject(target[key]) && Object.keys(src[key]).length > 0) ssr_window_esm_extend(target[key], src[key]);
        }));
    }
    const ssrDocument = {
        body: {},
    ...
    function utils_extend() {
        ...
        for (let i = 1; i < arguments.length; i += 1) {
            ...
            if (nextSource !== void 0 && nextSource !== null && !utils_isNode(nextSource)) {
    ...
    window.addEventListener("DOMContentLoaded", (() => {
        ...
        function createAnimation() {
            ...
            if (partnersSection) {
                ...
                const advisersTitleSpan = document.querySelectorAll(".advisers__title .word");
                const advisersSubTitleSpan = document.querySelectorAll(".advisers__subtitle .word .word-span");
                gsap.timeline({
                    scrollTrigger: {
                        trigger: partnersSection,
                        start: "top 15%",
